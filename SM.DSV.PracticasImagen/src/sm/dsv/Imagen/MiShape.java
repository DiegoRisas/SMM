...
public abstract class MiShape extends RectangularShape {
    ...
    /*
    public Elipse MarcadorSeleccion(Point2D aux){
        Point2D location = aux;
        this.color = Color.RED;;
        this.trazo = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10, new float[]{5}, 0);;
        return  new Elipse(location.getX(), location.getY(), 10);
    }
    */
}
