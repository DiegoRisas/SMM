...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        abrirCamaraButton = new javax.swing.JButton();
        CapturaButton = new javax.swing.JButton();
        ...
        abrirCamaraButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/Camara.png"))); // NOI18N
        abrirCamaraButton.setFocusable(false);
        abrirCamaraButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        abrirCamaraButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        abrirCamaraButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                abrirCamaraButtonActionPerformed(evt);
            }
        });
        jToolBar2.add(abrirCamaraButton);

        CapturaButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/Capturar.png"))); // NOI18N
        CapturaButton.setFocusable(false);
        CapturaButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        CapturaButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        CapturaButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CapturaButtonActionPerformed(evt);
            }
        });
        jToolBar2.add(CapturaButton);
    ...
    private void abrirCamaraButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_abrirCamaraButtonActionPerformed
        VentanaInternaCamara vc = VentanaInternaCamara.getInstance();
        if(vc != null){
            escritorio.add(vc);
            vc.setVisible(true);
        }
    }//GEN-LAST:event_abrirCamaraButtonActionPerformed
    ...
    private void CapturaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CapturaButtonActionPerformed
        ...
        if(vc!= null){
            BufferedImage auxImg = vc.getImage();
            VentanaInterna vi = new VentanaInterna();
            vi.getLienzo2D().setImg(auxImg);
            escritorio.add(vi);
            vi.setVisible(true);
        }
    }//GEN-LAST:event_CapturaButtonActionPerformed
    ...
    private void menuAbrirVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAbrirVideoActionPerformed
        ...
        if( resp == JFileChooser.APPROVE_OPTION) {
            try{
                File aux = dlg.getSelectedFile();
                VentanaInternaVideo vv = VentanaInternaVideo.getInstance(aux);
                escritorio.add(vv);
                vv.setVisible(true);
    ...
    private javax.swing.JButton CapturaButton;
    ...
    private javax.swing.JButton abrirCamaraButton;
